...
MedPharm ERP ships with two complementary PDF manuals, each generated by a self-contained ReportLab script under `docs/`. Volume I describes what the software **is**; Volume II describes what it **does under an operator's care**. They are designed to be read together.

| Volume | File | Generator | Audience |
|--------|------|-----------|----------|
| I — Technical Reference | `docs/MedPharm_ERP_Documentation.pdf` | `docs/generate_pdf.py` | Developers, architects, integrators |
