...
#
# Compile the Foundation-only subset of the iOS client (Models + QRConfigParser)
# using the Apple-shipped Swift toolchain on Linux. Catches type errors and
# Codable / protocol breakage in seconds, without xcodebuild or a Mac.
#
...
echo "Compile-checking portable iOS sources (Models + QRConfigParser)..."
