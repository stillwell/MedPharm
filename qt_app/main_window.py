...
from PyQt6.QtGui import QAction, QFont, QPixmap, QIcon, QDesktopServices
...
_HELP_PATH = os.path.join(_QT_RES, "help.html")
...
class MainWindow(QMainWindow):
    ...
    def show_user_guide(self):
        if not os.path.exists(_HELP_PATH):
            QMessageBox.warning(
                self, "User Guide unavailable",
                "The bundled help file was not found at:\n"
                f"{_HELP_PATH}\n\n"
                "Reinstall the application or restore the qt_app/resources/ "
                "directory from the source tree."
            )
            return
        QDesktopServices.openUrl(QUrl.fromLocalFile(_HELP_PATH))
